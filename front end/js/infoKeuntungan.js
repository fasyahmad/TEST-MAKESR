        ...
        for (var i = 0; i < modal.length; i++) {
            var modals =
               ...
               <div class="col-sm">
                            ...
                            <div class="col-sm">
                                <p style="font-size:20px;" id="harga_beli">${modal[i]['harga_beli']}</p>
                            </div>
                            <div class="col-sm">
                                <p style="font-size:20px;" id="harga_jual">${modal[i]['harga_jual']}</p>
                            </div>
                            <div class="col-sm">
                                <p style="font-size:20px;" id="harga_jual">${(modal[i]['jumlah_barang'] * modal[i]['harga_jual']) - (modal[i]['harga_beli'] * modal[i]['jumlah_barang'])}</p>
                            </div>
                            </div>
               `
